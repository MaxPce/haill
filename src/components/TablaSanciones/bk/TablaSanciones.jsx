...
const TablaSanciones = () => {
    ...
    const generarEstructuraSanciones = () => {
        ...
        const sancionesPorAcreditado = sancionesOrdenadas.reduce((acc, sancion) => {
            ...
            if (sancion.nro_fecha > config.nro_fechas_grupo) {
                const etapaIndex = sancion.nro_fecha - config.nro_fechas_grupo - 1;
        ...
        console.log("ver el valor", sancionesPorAcreditado)
